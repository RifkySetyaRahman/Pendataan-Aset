    ...
    <div class="lg:ml-64">
        ...
        <main class="p-4 sm:p-6 lg:p-8">
            <div class="max-w-3xl mx-auto">
                ...
                <form 
    method="POST" 
    action="{{ route('manajemen-aset.store') }}" 
...
>{{ old('description') }}</textarea>
    ...
    required class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500">
                    ...
                    <div class="flex gap-3 justify-end mt-8 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" id="btnSelanjutnya" onclick="nextStep()" class="px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium">
